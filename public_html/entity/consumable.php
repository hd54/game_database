<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="ascensionMaterial.php">Ascension Consumable</a>
                    <a href="consumable.php" class="active">Consumable</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Consumable</h2>
            <form method="POST" action="consumable.php"> <!--refresh page when submitted-->
            ...
            <h2>Update Name in Consumable</h2>
            ...
            <form method="POST" action="consumable.php"> <!--refresh page when submitted-->
                ...
                New Recipe: <input type="text" name="newRecipe"> <br /><br />
            ...
            <h2>Count the Tuples in Consumable</h2>
            <form method="GET" action="consumable.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Consumable</h2>
            <form method="GET" action="consumable.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $result = executePlainSQL("SELECT * FROM Consumable WHERE name='" . $old_name . "'");
            ...
            $updateSQL = "UPDATE Consumable SET name='";
            $updateSQL .= $new_name . "', recipe='";
            $updateSQL .= $newRecipe . "' WHERE name='";
            $updateSQL .= $old_name . "'";
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into Consumable values (:bind1, :bind2)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM Consumable");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in consumables: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM Consumable ORDER BY Name OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }
        ...
        function printResult($result) {
            ...
            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                echo "<tr><td>" . $row["NAME"] . "</td><td>" . $row["RECIPE"] . "</td></tr>";
            }
        }
