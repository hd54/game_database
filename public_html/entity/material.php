<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="material.php" class="active">Material</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Material</h2>
            <form method="POST" action="material.php"> <!--refresh page when submitted-->
            ...
            <h2>Count the Tuples in Material</h2>
            <form method="GET" action="material.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Material</h2>
            <form method="GET" action="material.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $result = executePlainSQL("SELECT * FROM Material WHERE name='" . $old_name . "'");
            ...
            $updateSQL = "UPDATE Material SET name='";
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into Material (name, description) values (:bind1, :bind2)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            global $db_conn;
            $result = executePlainSQL("SELECT Count(*) FROM Material");
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM Material ORDER BY Name OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }
