<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="artifact.php" class="active">Artifacts</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Artifact</h2>
            <form method="POST" action="artifact.php"> <!--refresh page when submitted-->
                <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                Set Name: <input type="text" name="setName"> <br /><br />
                Name: <input type="text" name="name"> <br /><br />
                ArtifactType: <input type="text" name="artifactType"> <br /><br />
            ...
            <form method="POST" action="artifact.php"> <!--refresh page when submitted-->
                ...
                New ArtifactType: <input type="text" name="newArtifactType"> <br /><br />
            ...
            <h2>Count the Tuples in Artifact</h2>
            <form method="GET" action="artifact.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Artifact</h2>
            <form method="GET" action="artifact.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $new_artifact_type = $_POST['newArtifactType'];
            $new_description = $_POST['newDescription'];

            $result = executePlainSQL("SELECT * FROM Artifact WHERE name='" . $old_name . "' AND setname='". $old_set_name . "'");
            ...
            while (($row = oci_fetch_row($result)) != false) {
                ...
                if ($new_artifact_type == NULL) {
                    $new_artifact_type = $row[2];
                }
            ...
            $updateSQL = "UPDATE Artifact SET setname='";
            $updateSQL .= $new_set_name . "', name='";
            $updateSQL .= $new_name . "', artifacttype='";
            $updateSQL .= $new_artifact_type . "', description='";
            $updateSQL .= $new_description . "' WHERE name='";
            $updateSQL .= $old_name . "' AND setname='";
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into Artifact values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            global $db_conn;
            $result = executePlainSQL("SELECT Count(*) FROM Artifact");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in Artifacts: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM Artifact ORDER BY SETNAME, NAME OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }

        function printResult($result) {
            echo "<br>Retrieved data from Artifact Table:<br>";
            echo "<table>";
            echo "<tr>
                    <th>Set Name</th>
                    <th>Name</th>
            ...
            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                $table = "<tr><td>";
                $table .= $row["SETNAME"] . "</td><td>";
                $table .= $row["NAME"] . "</td><td>";
                $table .= $row["ARTIFACTTYPE"] . "</td><td>";
                $table .= $row["DESCRIPTION"] . "</td></tr>";
                echo $table;
            }
        }
