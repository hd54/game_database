<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="subregion.php" class="active">Subregion</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Subregion</h2>
            <form method="POST" action="subregion.php"> <!--refresh page when submitted-->
                <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                Region Name: <input type="text" name="regionName"> <br /><br />
                Subregion Name: <input type="text" name="subRegionName"> <br /><br />
                SubLore: <input type="text" name="subLore"> <br /><br />
                Zone Type: <input type="text" name="zoneType"> <br /><br />
            ...
            <h2>Update Name in Subregion</h2>
            ...
            <form method="POST" action="subregion.php"> <!--refresh page when submitted-->
                ...
                New SubLore: <input type="text" name="newSubLore"> <br /><br />
                New Zone Type: <input type="text" name="newZoneType"> <br /><br />
            ...
            <h2>Count the Tuples in Subregion</h2>
            <form method="GET" action="subregion.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Subregion</h2>
            <form method="GET" action="subregion.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $oldSubregionName = $_POST['oldSubregionName'];
            $newRegionName = $_POST['newRegionName'];
            $newSubregionName = $_POST['newSubregionName'];
            $newSubLore = $_POST['newSubLore'];
            $newZoneType = $_POST['newZoneType'];

            $result = executePlainSQL("SELECT * FROM Subregion WHERE rname='" . $oldRegionName . "' AND subname='" . $oldSubregionName . "'");

            while (($row = oci_fetch_row($result)) != false) {
                if ($newRegionName == NULL) {
                    $newRegionName = $row[0];
                }
                if ($newSubregionName == NULL) {
                    $newSubregionName = $row[1];
                }
                if ($newSubLore == NULL) {
                    $newSubLore = $row[2];
                }
            ...
            $updateSQL = "UPDATE Subregion SET rname='";
            $updateSQL .= $newRegionName . "', subname='";
            $updateSQL .= $newSubregionName . "', sublore='";
            $updateSQL .= $newSubLore . "', zonetype='";
            $updateSQL .= $newZoneType . "' WHERE rname='";
            $updateSQL .= $oldRegionName . "' AND subname='";
            $updateSQL .= $oldSubregionName . "'";
        ...
        function handleInsertRequest() {
            ...
            $tuple = array (
                ":bind1" => $_POST['regionName'],
                ":bind2" => $_POST['subregionName'],
                ":bind3" => $_POST['subLore'],
                ":bind4" => $_POST['zoneType']
            );
            ...
            executeBoundSQL("insert into Subregion values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM Subregion");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in Subregions: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM Subregion ORDER BY RName, SubName OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }

        function printResult($result) {
            echo "<br>Retrieved data from Subregion Table:<br>";
            echo "<table>";
            echo "<tr>
                    <th>Region Name</th>
