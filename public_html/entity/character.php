<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="character.php" class="active">Character</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Character</h2>
            <form method="POST" action="character.php"> <!--refresh page when submitted-->
                <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                Name: <input type="text" name="name"> <br /><br />
                Elemental Type: <input type="text" name="elementalType"> <br /><br />
                Gender: <input type="text" name="gender"> <br /><br />
                Weapon Type: <input type="text" name="weaponType"> <br /><br />
            ...
            <h2>Update Name in Character</h2>
            ...
            <form method="POST" action="character.php"> <!--refresh page when submitted-->
                ...
                New Elemental Type: <input type="text" name="newElementalType"> <br /><br />
                New Gender: <input type="text" name="newGender"> <br /><br />
            ...
            <h2>Count the Tuples in Character</h2>
            <form method="GET" action="character.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Character</h2>
            <form method="GET" action="character.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $newElementalType = $_POST['newElementalType'];
            $newGender = $_POST['newGender'];
            $newWeaponType = $_POST['newWeaponType'];
            $newTier = $_POST['newTier'];
            $newDescription = $_POST['newDescription'];
            $newStatID = $_POST['newStatID'];
            $newRegionName = $_POST['newRegionName'];

            $result = executePlainSQL("SELECT * FROM Character WHERE name='" . $old_name . "'");
            while (($row = oci_fetch_row($result)) != false) {
                if ($new_name == NULL) {
                    $new_name = $row[0];
                }
                if ($newElementalType == NULL) {
            ...
            $updateSQL = "UPDATE Character SET name='";
            $updateSQL .= $new_name . "', elementaltype='" ;
            $updateSQL .= $newElementalType . "', gender='" ;
            $updateSQL .= $newGender . "', weapontype='" ;
            $updateSQL .= $newWeaponType . "', tier='" ;
            $updateSQL .= $newTier . "', description='" ;
            $updateSQL .= $newDescription . "', statid='" ;
            $updateSQL .= $newStatID . "', regionname='" ;
            $updateSQL .= $newRegionName . "' WHERE name='" . $old_name . "'";
        ...
        function handleInsertRequest() {
            ...
            $tuple = array (
                ":bind1" => $_POST['name'],
                ":bind2" => $_POST['elementalType'],
                ":bind3" => $_POST['gender'],
                ":bind4" => $_POST['weaponType'],
                ":bind5" => $_POST['tier'],
                ":bind6" => $_POST['description'],
                ":bind7" => $_POST['statID'],
                ":bind8" => $_POST['regionName'],
            ...
            executeBoundSQL("insert into Character values (:bind1, :bind2, :bind3, :bind4, :bind5, :bind6, :bind7, :bind8)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM Character");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in Character Table: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM Character ORDER BY NAME OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }
        ...
        function printResult($result) {
            ...
            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                $table = "<tr><td>";
                $table .= $row["NAME"] . "</td><td>"; 
                $table .= $row["ELEMENTALTYPE"] . "</td><td>";
                $table .= $row["GENDER"] . "</td><td>";
                $table .= $row["WEAPONTYPE"] . "</td><td>";
                $table .= $row["TIER"] . "</td><td>";
                $table .= $row["DESCRIPTION"] . "</td><td>";
                $table .= $row["STATID"] . "</td><td>";
                $table .= $row["REGIONNAME"] . "</td></tr>";
                echo $table;
            }
        }
