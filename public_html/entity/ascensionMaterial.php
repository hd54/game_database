<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="ascensionMaterial.php" class="active">Ascension Material</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Ascension Material</h2>
            <form method="POST" action="ascensionMaterial.php"> <!--refresh page when submitted-->
                <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                Name: <input type="text" name="name"> <br /><br />
                Tier: <input type="text" name="tier"> <br /><br />
                AscensionType: <input type="text" name="ascensionType"> <br /><br />
            ...
            <h2>Update Name in Ascension Material</h2>
            ...
            <form method="POST" action="ascensionMaterial.php"> <!--refresh page when submitted-->
                ...
                New Ascension Type: <input type="text" name="newAscensionType"> <br /><br />
            ...
            <h2>Count the Tuples in Ascension Material</h2>
            <form method="GET" action="ascensionMaterial.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Ascension Material</h2>
            <form method="GET" action="ascensionMaterial.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $newAscensionType = $_POST['newAscensionType'];

            $result = executePlainSQL("SELECT * FROM AscensionMaterial WHERE name='" . $old_name . "'");
            ...
            while (($row = oci_fetch_row($result)) != false) {
                ...
                if ($newAscensionType == NULL) {
                    $newAscensionType = $row[2];
                }
            }

            // you need the wrap the old name and new name values with single quotations
            $updateSQL = "UPDATE AscensionMaterial SET name='";
            $updateSQL .= $new_name . "', tier='";
            $updateSQL .= $newTier . "', ascensiontype='";
            $updateSQL .= $newAscensionType . "' WHERE name='";
            $updateSQL .= $old_name . "'";
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into AscensionMaterial values (:bind1, :bind2, :bind3)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM AscensionMaterial");
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM AscensionMaterial ORDER BY Name OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }
        ...
        function printResult($result) {
            ...
            echo "<tr>
                    <th>Name</th>
                    <th>Tier</th>
                    <th>Ascension Type</th>
                    </tr>";

            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                echo "<tr><td>" . $row["NAME"] . "</td><td>" . $row["TIER"] .  "</td><td>" . $row["ASCENSIONTYPE"] . "</td></tr>";
            }
        }
