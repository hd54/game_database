<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="boss.php" class="active">Boss</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Boss</h2>
            <form method="POST" action="boss.php"> <!--refresh page when submitted-->
                <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                Name: <input type="text" name="name"> <br /><br />
                Required Resin: <input type="text" name="requiredResin"> <br /><br />
                Phases: <input type="text" name="phases"> <br /><br />
                ElementalType: <input type="text" name="elementalType"> <br /><br />
            ...
            <form method="POST" action="boss.php"> <!--refresh page when submitted-->
                ...
                New Required Resin: <input type="text" name="newRequiredResin"> <br /><br />
                New Phases: <input type="text" name="newPhases"> <br /><br />
            ...
            <h2>Count the Tuples in Boss</h2>
            <form method="GET" action="boss.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $newRequiredResin = $_POST['newRequiredResin'];
            $newPhases = $_POST['newPhases'];
            $newElementalType = $_POST['newElementalType'];

            $result = executePlainSQL("SELECT * FROM Boss WHERE name='" . $old_name . "'");

            while (($row = oci_fetch_row($result)) != false) {
                if ($new_name == NULL) {
                    $new_name = $row[0];
                }
                if ($newRequiredResin == NULL) {
                    $newRequiredResin = $row[1];
                }
                if ($newPhases == NULL) {
                    $newPhases = $row[2];
                }
                if ($newElementalType == NULL) {
                    $newElementalType = $row[3];
                }
            }

            // you need the wrap the old name and new name values with single quotations
            $updateSQL = "UPDATE Boss SET name='";
            $updateSQL .= $new_name . "', requiredresin='";
            $updateSQL .= $newRequiredResin . "', phases='";
            $updateSQL .= $newPhases . "', elementalType='";
            $updateSQL .= $newElementalType . "' WHERE name='";
            $updateSQL .= $old_name . "'";
        ...
        function handleInsertRequest() {
            ...
            $tuple = array (
                ":bind1" => $_POST['name'],
                ":bind2" => $_POST['requiredResin'],
                ":bind3" => $_POST['phases'],
                ":bind4" => $_POST['elementalType']
            );
            ...
            executeBoundSQL("insert into Boss values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM Boss");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in materials: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM Boss ORDER BY Name OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }

        function printResult($result) {
            echo "<br>Retrieved data from Boss Table:<br>";
            echo "<table>";
            echo "<tr>
                    <th>Name</th>
                    <th>Required Resin</th>
                    <th>Phases</th>
                    <th>Elemental type</th>
                    </tr>";

            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                echo "<tr><td>" . $row["NAME"] . "</td><td>" . $row["REQUIREDRESIN"] .  "</td><td>" . $row["PHASES"] .  "</td><td>" . $row["ELEMENTALTYPE"] . "</td></tr>";
            }
        }
