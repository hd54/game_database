<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="artifactSet.php" class="active">ArtifactSet</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Artifact Set</h2>
            <form method="POST" action="artifactSet.php"> <!--refresh page when submitted-->
                <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                Set Name: <input type="text" name="setName"> <br /><br />
                4 Piece Bonus: <input type="text" name="4pieceBonus"> <br /><br />
                2 Piece Bonus: <input type="text" name="2pieceBonus"> <br /><br />
            ...
            <h2>Update Name in Artifact Set</h2>
            <p>The values are case sensitive and if you enter in the wrong case, the update statement will not do anything.</p>

            <form method="POST" action="artifactSet.php"> <!--refresh page when submitted-->
                <input type="hidden" id="updateQueryRequest" name="updateQueryRequest">
                Set Name: <input type="text" name="oldSetName"> <br /><br />
                New Set Name: <input type="text" name="newSetName"> <br /><br />
                New 4 Piece Bonus: <input type="text" name="new4PieceBonus"> <br /><br />
                New 2 Piece Bonus: <input type="text" name="new2PieceBonus"> <br /><br />
            ...
            <h2>Count the Tuples in Artifact Set</h2>
            <form method="GET" action="artifactSet.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Artifact Set</h2>
            <form method="GET" action="artifactSet.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $old_set_name = $_POST['oldSetName'];
            $new_set_name = $_POST['newSetName'];
            $new4PieceBonus = $_POST['new4PieceBonus'];
            $new2PieceBonus = $_POST['new2PieceBonus'];
            $newTier = $_POST['newTier'];

            $result = executePlainSQL("SELECT * FROM ArtifactSET WHERE setname='" . $old_set_name . "'");

            while (($row = oci_fetch_row($result)) != false) {
                if ($new_set_name == NULL) {
                    $new_set_name = $row[0];
                }
                if ($new4PieceBonus == NULL) {
                    $new4PieceBonus = $row[1];
                }
                if ($new2PieceBonus == NULL) {
                    $new2PieceBonus = $row[2];
                }
                if ($newTier == NULL) {
                    $newTier = $row[3];
                }
            ...
            $updateSQL = "UPDATE ArtifactSet SET setname='";
            $updateSQL .= $new_set_name . "', 4piecebonus='";
            $updateSQL .= $new4PieceBonus . "', 2piecebonus='";
            $updateSQL .= $new2PieceBonus . "', tier='";
            $updateSQL .= $newTier . "' WHERE setname='";
            $updateSQL .= $old_set_name . "'";
        ...
        function handleInsertRequest() {
            ...
            $tuple = array (
                ":bind1" => $_POST['setName'],
                ":bind2" => $_POST['4pieceBonus'],
                ":bind3" => $_POST['2pieceBonus'],
                ":bind4" => $_POST['tier'],
            );
            ...
            executeBoundSQL("insert into ArtifactSet values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM ArtifactSet");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in Artifact Sets: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM ArtifactSet ORDER BY SETNAME OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }

        function printResult($result) {
            echo "<br>Retrieved data from Artifact Set Table:<br>";
            echo "<table>";
            echo "<tr>
                    <th>Set Name</th>
                    <th>4 Piece Bonus</th>
            ...
            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                $table = "<tr><td>" . $row["SETNAME"] . "</td><td>" . $row["4PIECEBONUS"] . "</td><td>";
                $table .= $row["2PIECEBONUS"] . "</td><td>" . $row["TIER"] . "</td></tr>";
                echo $table;
            }
        }
