<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="enemies.php" class="active">Enemies</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Enemies</h2>
            <form method="POST" action="enemies.php"> <!--refresh page when submitted-->
            ...
            <h2>Count the Tuples in Enemies</h2>
            <form method="GET" action="enemies.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $result = executePlainSQL("SELECT * FROM Enemies WHERE name='" . $old_name . "'");
            ...
            $updateSQL = "UPDATE Enemies SET name='";
            $updateSQL .= $new_name . "', description='";
            $updateSQL .= $newDescription . "', lore='";
            $updateSQL .= $newLore . "', statid='";
            $updateSQL .= $newStatID . "' WHERE name='";
            $updateSQL .= $old_name . "'";
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into Enemies values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM Enemies");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in Enemies: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM ENEMIES ORDER BY Name OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }
        ...
        function printResult($result) {
            ...
            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                echo "<tr><td>" . $row["NAME"] . "</td><td>" . $row["DESCRIPTION"] .  "</td><td>" . $row["LORE"] .  "</td><td>" . $row["STATID"] . "</td></tr>";
            }
        }
