<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="consumableBoosts.php" class="active">Consumable Boosts</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Consumable Boosts</h2>
            <form method="POST" action="consumableBoosts.php"> <!--refresh page when submitted-->
                <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                Consumable Name: <input type="text" name="consumableName"> <br /><br />
            ...
            <h2>Update Values in Consumable Boosts</h2>
            <p>The values are case sensitive and if you enter in the wrong case, the update statement will not do anything.</p>

            <form method="POST" action="consumableBoosts.php"> <!--refresh page when submitted-->
                <input type="hidden" id="updateQueryRequest" name="updateQueryRequest">
                Old Consumable Name: <input type="text" name="oldConsumableName"> <br /><br />
                New Consumable Name: <input type="text" name="newConsumableName"> <br /><br />
                Old Stat ID: <input type="text" name="oldStatID"> <br /><br />
                New Stat ID: <input type="text" name="oldStatID"> <br /><br />
            ...
            <h2>Count the Tuples in Consumable Boosts</h2>
            <form method="GET" action="consumableBoosts.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Consumable Boosts</h2>
            <form method="GET" action="consumableBoosts.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $old_consumableName = $_POST['oldConsumableName'];
            $new_consumableName = $_POST['newConsumableName'];
            $old_statId = $_POST['oldStatID'];
            $new_statId = $_POST['newStatID'];


            $result = executePlainSQL("SELECT * FROM ConsumableBoosts WHERE consumablename='" . $old_consumableName . "' AND statid='" . $old_statId . "'");

            while (($row = oci_fetch_row($result)) != false) {
                if ($new_consumableName == NULL) {
                    $new_consumableName = $row[0];
                }
                if ($new_statId == NULL) {
                    $new_statId = $row[1];
                }
            ...
            $updateSQL = "UPDATE ConsumableBoosts SET consumablename='";
            $updateSQL .= $new_consumableName . "', statid='";
            $updateSQL .= $new_statId . "' WHERE consumablename='";
            $updateSQL .= $old_consumableName . "'";
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into ConsumableBoosts values (:bind1, :bind2)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM ConsumableBoosts");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in Consumable Boosts Table: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM ConsumableBoosts ORDER BY ConsumableName, StatID OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }

        function printResult($result) {
            echo "<br>Retrieved data from Consumable Boosts Table:<br>";
            echo "<table>";
            echo "<tr>
            ...
            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                $table = "<tr><td>";
                $table .= $row["CONSUMABLENAME"] . "</td><td>";
                $table .= $row["STATID"] .  "</td><tr>";
                echo $table;
            }
        }
