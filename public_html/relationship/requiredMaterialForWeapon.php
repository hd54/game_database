<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="requiredMaterialForWeapon.php" class="active">Weapon Materials</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Weapon Materials</h2>
            <form method="POST" action="requiredMaterialForWeapon.php"> <!--refresh page when submitted-->
                <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                Weapon Name: <input type="text" name="weaponName"> <br /><br />
            ...
            <h2>Update Values in Weapon Materials</h2>
            <p>The values are case sensitive and if you enter in the wrong case, the update statement will not do anything.</p>

            <form method="POST" action="requiredMaterialForWeapon.php"> <!--refresh page when submitted-->
                <input type="hidden" id="updateQueryRequest" name="updateQueryRequest">
                Old Weapon Name: <input type="text" name="oldWeaponName"> <br /><br />
                New Weapon Name: <input type="text" name="newWeaponName"> <br /><br />
            ...
            <h2>Count the Tuples in Weapon Materials</h2>
            <form method="GET" action="requiredMaterialForWeapon.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Weapon Materials</h2>
            <form method="GET" action="requiredMaterialForWeapon.php"> <!--refresh page when submitted-->
        ...
        function connectToDB() {
            ...
            $db_conn = OCILogon("ora_yuguo790", "a34418582", "dbhost.students.cs.ubc.ca:1522/stu");
        ...
        function handleUpdateRequest() {
            ...
            $old_weaponName = $_POST['oldWeaponName'];
            $new_weapon_name = $_POST['newWeaponName'];
            $old_AscensionMaterialName = $_POST['oldAscensionMaterialName'];
            $new_AscensionMaterialName = $_POST['newAscensionMaterialName'];
            $newQuantity = $_POST['newQuantity'];


            $result = executePlainSQL("SELECT * FROM RequiredMaterialForWeapon WHERE weaponname='" . $old_weaponName . "' AND ascensionmaterial='" . $old_AscensionMaterialName . "'");
            ...
            $updateSQL = "UPDATE RequiredMaterialForWeapon SET weaponname='";
            $updateSQL .= $new_weaponName . "', ascensionmaterial='";
            $updateSQL .= $new_AscensionMaterialName . "', quantity='";
            $updateSQL .= $newQuantity . "' WHERE weaponname='";
            $updateSQL .= $old_weaponName . "' AND ascensionmaterial='";
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into RequiredMaterialForWeapon values (:bind1, :bind2, :bind3)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM RequiredMaterialForWeapon");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in Weapon Materials Table: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM RequiredMaterialForWeapon ORDER BY Weaponname, AscensionMaterial OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }

        function printResult($result) {
            echo "<br>Retrieved data from Weapon Materials Table:<br>";
            echo "<table>";
            echo "<tr>
                    <th>Weapon Name</th>
                    <th>Ascension Material</th>
                    <th>Quantity</th>
                    </tr>";

            while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                $table = "<tr><td>";
                $table .= $row["WEAPONNAME"] . "</td><td>";
                $table .= $row["ASCENSIONMATERIAL"] . "</td><td>";
