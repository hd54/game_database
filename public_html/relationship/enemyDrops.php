<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="enemyDrops.php" class="active">Enemy Drops</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into EnemyDrops</h2>
            <form method="POST" action="enemyDrops.php"> <!--refresh page when submitted-->
            ...
            <h2>Update Values in EnemyDrops</h2>
            <p>The values are case sensitive and if you enter in the wrong case, the update statement will not do anything.</p>

            <form method="POST" action="enemyDrops.php"> <!--refresh page when submitted-->
                <input type="hidden" id="updateQueryRequest" name="updateQueryRequest">
                Old Enemy Name: <input type="text" name="oldEnemyName"> <br /><br />
                New Enemy Name: <input type="text" name="newEnemyName"> <br /><br />
            ...
            <h2>Count the Tuples in EnemyDrops</h2>
            <form method="GET" action="enemyDrops.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in EnemyDrops</h2>
            <form method="GET" action="enemyDrops.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $old_name = $_POST['oldEnemyName'];
            $new_name = $_POST['newEnemyName'];
            $oldMaterialName = $_POST['oldMaterialName'];
            $newMaterialName = $_POST['newMaterialName'];


            $result = executePlainSQL("SELECT * FROM Enemydrops WHERE enemyname='" . $old_name . "' AND materialname='" . $oldMaterialName . "'");
            ...
            while (($row = oci_fetch_row($result)) != false) {
                ...
                if ($newMaterialName == NULL) {
                    $newMaterialName = $row[1];
                }
            }

            // you need the wrap the old name and new name values with single quotations
            $updateSQL = "UPDATE Enemydrops SET enemyname='";
            $updateSQL .= $new_name . "', materialname='";
            $updateSQL .= $newMaterialName . "' WHERE enemyname='";
            $updateSQL .= $old_name . "' AND materialname='";
            $updateSQL .= $oldMaterialName . "'";
        ...
        function handleInsertRequest() {
            ...
            $tuple = array (
                ":bind1" => $_POST['enemyName'],
                ":bind2" => $_POST['materialName'],
            ...
            executeBoundSQL("insert into Enemydrops values (:bind1, :bind2)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM Enemydrops");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in EnemyDrops Table: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM Enemydrops ORDER BY Enemyname, MaterialName OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }

        function printResult($result) {
            echo "<br>Retrieved data from Enemy Drops Table:<br>";
            echo "<table>";
            echo "<tr>
                    <th>Enemy Name</th>
                    <th>Material Name</th>
