<html>
    ...
    <body>
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="characterCanWield.php" class="active">Character Weapon Ranking</a>
        ...
        <div style="padding:20px; margin-top:30px">
            ...
            <h2>Insert Values into Character Weapon Ranking</h2>
            <form method="POST" action="characterCanWield.php"> <!--refresh page when submitted-->
            ...
            <h2>Update Values in Character Weapon Ranking</h2>
            <p>The values are case sensitive and if you enter in the wrong case, the update statement will not do anything.</p>

            <form method="POST" action="characterCanWield.php"> <!--refresh page when submitted-->
                <input type="hidden" id="updateQueryRequest" name="updateQueryRequest">
                Old Character Name: <input type="text" name="oldName"> <br /><br />
                New Character Name: <input type="text" name="newName"> <br /><br />
            ...
            <h2>Count the Tuples in Character Weapon Ranking</h2>
            <form method="GET" action="characterCanWield.php"> <!--refresh page when submitted-->
            ...
            <h2>Print Tuples in Character Weapon Ranking</h2>
            <form method="GET" action="characterCanWield.php"> <!--refresh page when submitted-->
        ...
        function handleUpdateRequest() {
            ...
            $oldWeaponName = $_POST['oldWeaponName'];
            $newWeaponName = $_POST['newWeaponName'];
            $newRank = $_POST['newRank'];


            $result = executePlainSQL("SELECT * FROM CharacterCanWield WHERE charactername='" . $old_name . "' And weaponname='" . $oldWeaponName . "'");
            ...
            $updateSQL = "UPDATE CharacterCanWield SET charactername='";
            $updateSQL .= $new_name . "', weaponname='";
            $updateSQL .= $newWeaponName . "', rank='";
            $updateSQL .= $newRank . "' WHERE charactername='";
            $updateSQL .= $old_name . "' AND weaponname='";
            $updateSQL .= $oldWeaponName . "'";
        ...
        function handleInsertRequest() {
            ...
            executeBoundSQL("insert into CharacterCanWield values (:bind1, :bind2, :bind3)", $alltuples);
            if ($success) {
        ...
        function handleCountRequest() {
            ...
            $result = executePlainSQL("SELECT Count(*) FROM CharacterCanWield");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in Character Weapon Ranking Table: " . $row[0] . "<br>";
            }
        }
        ...
        function handlePrintRequest() {
            ...
            $result = executeBoundSQL("SELECT * FROM CharacterCanWield ORDER BY CharacterName, WeaponName OFFSET (:bind1)*10 ROWS FETCH NEXT 10 ROWS ONLY", $alltuples);
            printResult($result);
        }

        function printResult($result) {
            echo "<br>Retrieved data from Character Weapon Ranking Table:<br>";
            echo "<table>";
            echo "<tr>
